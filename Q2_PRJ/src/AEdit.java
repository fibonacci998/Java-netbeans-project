...
public class AEdit extends javax.swing.JFrame {
    ...
    public AEdit() {
        initComponents();
        //txtText.getInputMap((int) put(KeyStroke.getKeyStroke(KeyEvent.VK_H, KeyEvent.CTRL_MASK), "none"));
        txtText.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_H, KeyEvent.CTRL_MASK), "none");
    }
    ...
    private void initComponents() {
        ...
        txtText.setFont(new java.awt.Font("Monospaced", 0, 36)); // NOI18N
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        JDialog replace=new ReplaceDialog(this, true);
